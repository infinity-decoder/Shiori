...
<div class="container">
  ...
  <div class="card card-soft">
        ...
        <table class="table table-striped mb-0">
          ...
          <?php else: ?>
            ...
            <tr>
              ...
              <td style="width:80px">
    <?php
    $photoUrl = ImageService::getPhotoUrl($s['photo_path'] ?? null, (int)$s['id'], true);
    if ($photoUrl && file_exists(BASE_PATH . $photoUrl)): ?>
    ...
    <?php else: ?>
        <div class="bg-light text-muted d-inline-flex align-items-center justify-content-center" 
             style="height:56px; width:56px; border-radius:4px;">
